...
const expertise = ["Social Media Marketing", "Digital Marketing & SEO", "Web Designing", "Web Development", "AI Automation Tasks"];
const skillPlaceholders = ["Social media workflows", "Digital marketing & SEO", "Web designing", "Web development", "AI automation tasks"];
    ...
    <section className="relative overflow-hidden py-20 sm:py-28 lg:py-32">
      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[0.88fr_1.12fr] lg:gap-24">
          ...
          <motion.div initial={{ opacity: 1, y: reduceMotion ? 0 : 18 }} animate={{ opacity: 1, y: 0 }} transition={{ ...transition, delay: reduceMotion ? 0 : 0.12 }}>
            ...
            <p className="mt-8 max-w-xl text-base leading-8 text-[var(--muted)] sm:text-lg">Affan helps businesses bring focused social, digital, web, and automation work into one clear direction.</p>
