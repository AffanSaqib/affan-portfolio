...
type Project = { title: string; category: Exclude<Category, "All">; detail: string; tone: "blue" | "violet" | "ink"; image: string };

const projects: Project[] = [
  { title: "Carpools UAE", category: "Social Media Marketing", detail: "Business page project", tone: "blue", image: "/assets/carpools-uae.png" },
  { title: "Ultimate Group International", category: "Social Media Marketing", detail: "Business page project", tone: "violet", image: "/assets/ultimate-group.png" },
  { title: "Apex Signal", category: "Social Media Marketing", detail: "Business page project", tone: "ink", image: "/assets/apex-signal.png" },
  { title: "AI Automation Tool", category: "Web Development", detail: "Development & automation project", tone: "violet", image: "/assets/ai-automation.png" },
  { title: "WTFStudio Ecommerce Store Management", category: "Web Development", detail: "Ecommerce & store management project", tone: "blue", image: "/assets/wtfstudio.png" },
];
